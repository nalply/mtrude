 ...
 *       type:      One of the fields of rtmp.ping
...
p.handlePing = function(data) {
  ...
  var ping = { type: data.readUInt16BE(0) };
  switch (ping.type) {
    case rtmp.ping.BEGIN:
    case rtmp.ping.EOF:
    case rtmp.ping.DRY:
    case rtmp.ping.RECORDED:
